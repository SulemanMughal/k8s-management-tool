...
from .views import create_daemonset_view, describe_daemonset_view, list_daemonsets_view, update_daemonset_image_view, delete_daemonset_view, get_pods_managed_by_daemonsets_view, get_pods_managed_by_specific_daemonset_view, update_daemonset_node_selector_view, update_daemonset_node_affinity_view, pause_daemonset_view, resume_daemonset_view,get_nodes_for_daemonset_view, change_daemonset_namespace_view, daemonset_rollout_status_view,daemonset_rollout_status_periodic_view, get_daemonset_events_view, update_rollout_history_view,get_rollout_history_view
urlpatterns = [
